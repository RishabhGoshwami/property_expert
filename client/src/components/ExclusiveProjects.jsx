        ...
        <div className="grid gap-8 sm:gap-10 md:grid-cols-2 lg:grid-cols-3">
          {exclusiveProjects.map((project, i) => {
            ...
            return (
              <div
                key={i}
                className="relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 group bg-white border border-gray-100"
              >
                {/* Project Image */}
                {project.image && (
                  <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-transparent to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-500"></div>
